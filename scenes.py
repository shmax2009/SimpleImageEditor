...
brightness_scene.add_text((int(210 / 1.5), int(614 / 1.5)), "-", (0, 0, 0), font_for_heading)
brightness_scene.add_text((int(790 / 1.5), int(615 / 1.5)), "+", (0, 0, 0), font_for_heading)
brightness_scene.add_text((int(500 / 1.5), int(650 / 1.5)), "change brightness of the chosen photo", (0, 0, 0), font_for_heading)
...
color_scene.add_text((int(210 / 1.5), int(614 / 1.5)), "-", (0, 0, 0), font_for_heading)
color_scene.add_text((int(790 / 1.5), int(615 / 1.5)), "+", (0, 0, 0), font_for_heading)
color_scene.add_text((int(500 / 1.5), int(650 / 1.5)), "change color saturation of the chosen photo", (0, 0, 0), font_for_heading)
rect = pygame.Rect(int(200 / 1.5), int(600 / 1.5), int(600 / 1.5), int(30 / 1.5))
...
sharp_scene.add_text((int(210 / 1.5), int(614 / 1.5)), "-", (0, 0, 0), font_for_heading)
sharp_scene.add_text((int(790 / 1.5), int(615 / 1.5)), "+", (0, 0, 0), font_for_heading)
sharp_scene.add_text((int(500 / 1.5), int(650 / 1.5)), "change sharpness of the chosen photo", (0, 0, 0), font_for_heading)
rect = pygame.Rect(int(200 / 1.5), int(600 / 1.5), int(600 / 1.5), int(30 / 1.5))
...
contrast_scene.add_text((int(210 / 1.5), int(614 / 1.5)), "-", (0, 0, 0), font_for_heading)
contrast_scene.add_text((int(790 / 1.5), int(615 / 1.5)), "+", (0, 0, 0), font_for_heading)
contrast_scene.add_text((int(500 / 1.5), int(650 / 1.5)), "change contrast of the chosen photo", (0, 0, 0), font_for_heading)
rect = pygame.Rect(int(200 / 1.5), int(600 / 1.5), int(600 / 1.5), int(30 / 1.5))
